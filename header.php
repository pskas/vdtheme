...
<div id="page" class="hfeed site">
	<header id="masthead" class="site-header" role="banner">
		...
		<nav role="navigation" class="site-navigation main-navigation">
			<h1 class="assistive-text"><?php _e( 'Menu', 'vdtheme' ); ?></h1>
			<div class="assistive-text skip-link"><a href="#content" title="<?php esc_attr_e( 'Skip to content', 'vdtheme' ); ?>"><?php _e( 'Skip to content', 'vdtheme' ); ?></a></div>

			<?php wp_nav_menu( array( 'theme_location' => 'primary', 'depth' => 1 ) ); ?>
		</nav><!-- .site-navigation .main-navigation -->

		<?php do_action( 'vdtheme_header_after' ); ?>
